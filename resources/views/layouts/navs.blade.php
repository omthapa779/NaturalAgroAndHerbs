...
<body>
    <div class="main_container padding_vxs">
        <navs class="navbar w_100 h_10vh padding_s10 flex justify_sb ">
            <div class="right_nav h_100 flex align_c gap_xs">
            ...
            <div class="left_nav h_100 flex align_c gap_xs">
                <h3><a href="#" class="primary_link_button button_hover">View Products</a></h3>
                <h3><a href="#" class="primary_link_button secondary_link_button button_hover">Inquire Now!</a></h3>
            </div>
        </navs>
        @yield('content')
    </div>
    <!-- Load Lenis with defer to improve page load performance -->
