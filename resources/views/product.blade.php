                ...
                @else
                    ...
                    <div class="product_card bg_white bradius_s shadow_m overflow_h hover_up">
                        ...
                        <div class="product_card_content flex_cl gap_xs padding_sxxs padding_vxxs">
                            ...
                            <div class="flex_cl gap_xs w_100 ">
                                <div class="flex_cl gap_xxs w_100">
                                    @if($product->sizes && count($product->sizes) > 1)
                                    <select class="size-selector contact_input padding_vxxs bradius_s w_100" data-product-id="{{ $product->id }}">
                    ...
                    <div class="flex_c w_100 mtop_m mbottom_m">
                        <button id="load-more" class="load_more_btn custom-button primary w_100" data-page="1" data-category="{{ request()->category ?? 'all' }}" data-featured="{{ request()->featured ?? '' }}" data-search="{{ request()->search ?? '' }}">
